...
```{r}
BFI <- "./data/BFI231106.xlsx" %>% 
  read_excel(range = "A1:AA214",
             col_names = TRUE)
BFI %<>%
  data.frame
BFI %<>%
...
BFI_days <- as.numeric(difftime("2023-11-20 09:00:00", BFI$Time, units = 'days'))
BFI_hours <- as.numeric(difftime("2023-11-20 09:00:00", BFI$Time, units = 'hours'))
```
