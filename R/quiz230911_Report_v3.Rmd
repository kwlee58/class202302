...
랜덤화출석부에 있는 Red, Black 과 실제 구글예습퀴즈에 올린 Red, Black 이 여전히 다른 사람들이 있어서 파악해 보았습니다. Red를 Black 이라고 한 사람의 수효(33명)와 Black을 Red 라고 한 사람의 수효(31명)가 많이 닮아서 굳이 표준오차와 p-value 를 계산하지 않아도 될 수준입니다. 요약의 일관성을 기하기 위하여 기대값과 표준오차를 계산해 봅니다. 64명을 랜덤하게 둘로 나누면 32명 $\pm\sqrt62/2$명 = 32 $\pm$ 4명의 범위에 매우 잘 들어가는 것을 알 수 있습니다. 
