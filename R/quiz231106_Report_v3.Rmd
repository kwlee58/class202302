...
quiz$days <- as.numeric(difftime("2023-11-20 09:00:00", quiz$time, 
                                 tz = "Asia/Seoul", units = 'days'))
quiz$hours <- as.numeric(difftime("2023-11-20 09:00:00", quiz$time, 
...
title(main = paste0("Quiz2311060 (", N, "명 제출)"))
