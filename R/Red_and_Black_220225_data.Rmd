...
```{r, data}
class_roll <- read_excel("../data/class_roll220225.xlsx", 
                        range = "B1:G808")
str(class_roll)
# class_roll <- read_excel("../data/class_roll220225.xlsx", 1, 
#                         startRow = 1, 
#                         endRow = 487, 
#                         colIndex = c(2:7), 
...
<!--
```{r, save}
save.image("./red_and_black_220225_data.RData")
```
-->