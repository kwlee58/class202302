...
```{r, echo = FALSE}
hist(Xsum, prob = TRUE, nclass = 50, xlim = c(0, 40), ylim = c(0, 0.1))
x <- seq(0, 40, by = 0.1)
lines(x, dchisq(x, df = 10), col = "red")
legend("topright", inset = 0.05, legend = c("Xsum", "Chi-square(16)"), col = c("black", "red"), lty = 1)
plot(density(Xsum), xlim = c(0, 40), ylim = c(0, 0.1), main = "Density Estimation of Xsum")
lines(x, dchisq(x, df = 10), col = "red")
```
...
<!--
```{r, save}
save.image("./red_and_black_optimum_data_202301_college.RData")
```
-->