...
quiz$days <- as.numeric(difftime("2023-11-06 09:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-11-06 09:00:00", quiz$time, units = 'hours'))
quiz %>% 
  str  
```
...
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz231023 (", N, "명 제출)"))
